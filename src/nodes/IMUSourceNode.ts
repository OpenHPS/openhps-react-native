...
import { Euler } from '@openhps/core';
...
export class IMUSourceNode extends SourceNode<IMUDataFrame> {
    ...
    public start(): Promise<void> {
        return new Promise<void>((resolve) => {
            ...
            this._subscriptionMag = magnetometer.subscribe(rotation => {
                ...
                if (this._lastPush < rotation.timestamp && this._acceleration !== undefined  && this._rotationRate !== undefined) {
            ...
            this._subscriptionGyro = gyroscope.subscribe(rotationRate => {
                ...
                if (this._lastPush < rotationRate.timestamp && this._acceleration !== undefined && this._rotation !== undefined) {
            ...
            this._subscriptionAcc = accelerometer.subscribe(acceleration => {
                ...
                if (this._lastPush < acceleration.timestamp && this._rotation !== undefined && this._rotationRate !== undefined) {
    ...
    public createFrame(): Promise<void> {
        return new Promise<void>((resolve) => {
            ...
            dataFrame.absoluteOrientation = Orientation.fromEuler(new Euler(
                this._rotation.x, 
                this._rotation.y, 
                this._rotation.z));
            ...
            dataFrame.source.addRelativePosition(new RelativeValue(
                "MAG_X",
                this._rotation.x
            ));
            dataFrame.source.addRelativePosition(new RelativeValue(
