  ...
  constructor(props: IProps) {
    ...
    this.state = {
      ...
      bounds: [
        this.props.topLeft,
        [
          this.props.topLeft[0] -
            (this.props.height / 1000 / EARTH_RADIUS) * (180 / Math.PI),
          this.props.topLeft[1] +
            ((this.props.width / 1000 / EARTH_RADIUS) * (180 / Math.PI)) /
              Math.cos((this.props.topLeft[0] * Math.PI) / 180),
        ],
      ],
    };
  }
